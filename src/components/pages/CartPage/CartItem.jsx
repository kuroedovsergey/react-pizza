function CartItem({
  ...
  const handleRemoveItemCart = () => {
    onSetRemoveItemCart(id);
  };

  const handlePlusItemCart = () => {
    onSetPlusCartItem(id);
  }

  const handleMinusCart = () => {
    onSetMinusCartItem(id)
  }
  ...
  return (
    <div className="cart__item">
      ...
      <div className="cart__item-count">
        <div onClick={handleMinusCart} className={`${totalCount > 1 ? "button button--outline button--circle cart__item-count-minus" : 'hidden'}`}>
          <svg
            width="32"
            height="32"
            viewBox="0 0 32 32"
        ...
        <b>{totalCount}</b>
        <div onClick={handlePlusItemCart} className="button button--outline button--circle cart__item-count-plus">
          <svg
            width="32"
            height="32"
            viewBox="0 0 32 32"
